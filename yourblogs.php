			...
			<div class="header-nav1">
				<div class="wrap">
					<ul>
						...
						<li class="current"><a href="#">Your Blogs</a></li>
		...
		<script>
		    ...
		    function fillBlogs(blogs) {
		        ...
		        $.each(JSON.parse(blogs), function(i, blog) {
					...
					if(blog_isactive=="1") visibility="hidden";
						else var visibility = "show";
		                	...
		                	var row='<div class="wrap">'+
											'<div class="bloger-grid">'+
												...
												'<div class="bloger-content">'+
													...
													'</ul>'+
												'</div>'+
												'<p id="msg2" style="color:red;" align="center" class=" '+ visibility +' " >This Blog Is Not Yet Approved By The Admin!</p>'+
											'</div>'+
									'</div>'+
									'<div class="clear"> </div>';
